...
import { Wand2, KeyRound, Mail, MapPin, User as UserIcon } from 'lucide-react';
      ...
      <div className="sm:mx-auto sm:w-full sm:max-w-md">
        <div className="flex justify-center flex-col items-center">
          ...
          <p className="mt-2 text-center text-sm text-gray-600">
            Join Restyle Multi-User for free and get 5 redesign credits!
          </p>
        </div>
      </div>
      ...
      <div className="mt-8 sm:mx-auto sm:w-full sm:max-w-md border border-gray-100 rounded-3xl overflow-hidden shadow-sm">
        <div className="bg-white py-8 px-4 sm:rounded-lg sm:px-10">
          <form className="space-y-6" onSubmit={handleSubmit}>
            ...
            <div>
              <label className="block text-sm font-medium text-gray-700">City, State (Optional)</label>
              <div className="mt-1 relative rounded-md shadow-sm">
                <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
